    ...
    public function tambah_surat_masuk()
{
    ...
    $this->form_validation->set_rules('fas_alkes', 'alat kesehatan', 'required');
    $this->form_validation->set_rules('fas_elektronik', 'elektronik', 'required');

    $status = [
        1 => 'Kamar Kosong',  // Kosong
        2 => 'Kamar Terisi',  // Full Kamar
    ];
    ...
    if ($this->form_validation->run() == FALSE) {
        ...
        if (!$this->upload->do_upload('file_surat')) {
            ...
            $save = [
                'nama_surat_masuk' => $this->input->post("nama_surat", TRUE),
                'keterangan_surat_masuk' => $this->input->post("keterangan_surat", TRUE),
                'fas_alkes' => $this->input->post("fas_alkes", TRUE),
                'fas_elektronik' => $this->input->post("fas_elektronik", TRUE),
...
public function updateStatusKamar($id)
{
    ...
    public function editSuratMasuk($id)
    {
        ...
        $this->form_validation->set_rules('keterangan_surat', 'Keterangan', 'required');
        $this->form_validation->set_rules('fas_alkes', 'alat kesehatan', 'required');
        $this->form_validation->set_rules('fas_elektronik', 'elektroni', 'required');
