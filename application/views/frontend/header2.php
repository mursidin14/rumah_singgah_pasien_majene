...
<body id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
		<div class="container">
			<a class="navbar-brand js-scroll-trigger" href="<?= base_url('home')?>"><img style="width: 200px; height: 50px;" src="<?= base_url()?>assets/img/logos.png"
					alt="RSP_majene" /></a>
				...
				<li class="nav-item">
					...
					<li class="nav-item">
						<div class="dropdown">
							...
							<ul class="dropdown-menu bg-dark" aria-labelledby="dropdownMenu1">
								<li class="nav-item"><a class="nav-link <?php if ($title == 'Kamar') : ?><?= 'active';?><?php endif;?>" href="<?= base_url('kamar')?>">Kamar</a></li>
