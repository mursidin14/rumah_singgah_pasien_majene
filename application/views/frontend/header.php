...
<body id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
		<div class="container">
			<a class="navbar-brand js-scroll-trigger" href="<?= base_url('home')?>"><img style="width: 200px; height: 50px;" src="<?= base_url()?>assets/img/logos.png" alt="RSP_majene" /></a>
			<!-- <h3 class="navbar-brand js-scroll-trigger">Rumah Singgah Kab.Majene</h3> -->
				...
				<ul class="navbar-nav text-uppercase ml-auto">
					<li class="nav-item">
						<div class="dropdown">
							...
							<ul class="dropdown-menu bg-dark" aria-labelledby="dropdownMenu1">
								...
								<li><a class="nav-link" href="<?= base_url('visimisi')?>">Visi Misi</a></li>
								<li><a class="nav-link" href="<?= base_url('tujuan')?>">Maksud dan Tujuan</a></li>
								<li><a class="nav-link" href="<?= base_url('tatib')?>">Persyaratan dan Tata Tertib</a></li>
							</ul>
						</div>
					</li>
					...
					<li class="nav-item">
						<div class="dropdown">
							...
							<ul class="dropdown-menu bg-dark" aria-labelledby="dropdownMenu1">
								<li><a class="nav-link" href="<?= base_url('kamar')?>">Kamar</a></li>
								<li><a class="nav-link" href="<?= base_url('fasilitas')?>">Fasilitas</a></li>
							</ul>
						</div>
					</li>
					<li class="nav-item"><a class="nav-link" href="<?= base_url('peraturan')?>">Arsip</a></li>
					<li class="nav-item"><a class="nav-link" href="<?= base_url('tracking')?>">Track Pengajuan</a></li>
